...
insert into customers(id_customer,name_customer,country) values (21,'Mr. Park','South Korea');
insert into customers(id_customer,name_customer,country) values (22,'Mr. Backer','New Zealand');
...
insert into projects(id_project,name_project,id_company,id_customer) values (34,'Universe of Luigy',12,21);
...
insert into skills(id_skill,programming_language,skill_level) values (51,'Java','Senior');
insert into skills(id_skill,programming_language,skill_level) values (52,'Java','Middle');
insert into skills(id_skill,programming_language,skill_level) values (53,'C++','Junior');
insert into skills(id_skill,programming_language,skill_level) values (54,'C++','Senior');
insert into skills(id_skill,programming_language,skill_level) values (55,'JS','Middle');
insert into skills(id_skill,programming_language,skill_level) values (56,'JS','Junior');
